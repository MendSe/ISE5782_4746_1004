...
class SphereTest {
    ...
    void findIntsersections(){
        ...
        // ============ Equivalence Partitions Tests ==============
        //EP:01 Ray intersect sphere in 2 points
        ...
        //EP:04 Ray and tail no intersections
        ...
        //BVA:01 P0 on the Sphere and Ray out of it
        ...
        //BVA:02 P0 on the Sphere and Ray intersect the sphere in
        ...
        //BVA:05 tail tangent to the sphere
        ...
        //BVA:06 P0 on the sphere and the tail intersect with the center
        ...
        //BVA:07 P0 and the center are the same point
        ...
        //BVA:08 Ray starts after the sphere and his tail intersect the center
        ...
        //BVA:09 P0 on the sphere and ray goes through the center
        ...
        //BVA:10 Ray start in the sphere and his tail intersect the center
        result=sp.findIntsersections(new Ray(new Point(3,0,0),new Vector(4,0,0)));
        p1=new Point(4,0,0);
        assertEquals(1,result.size(),"Wrong number of points");
        assertEquals(result,List.of(p1),"Bad intersection when P0 is on the sphere and the ray goes through the center");

        //BVA:11 Ray start before the sphere and intersect it passing through the center
        p1=new Point(0,0,0);
        p2=new Point(4,0,0);
        ...
        // **** Group: Special cases
        //BVA:12 Ray outside the sphere and perpendicular to it center
