...
class TubeTest {
    ...
    void getNormal() {
        ...
        assertEquals(new Vector(1, 0, 0), tb0.getNormal(new Point(2, 1, 0)), "Bad normal to Tube");
        ...
        assertEquals(new Vector(1, 0, 0), tb1.getNormal(new Point(2, 0, 0)), "Bad normal to Tube when point on the same level as p0");
    }
}